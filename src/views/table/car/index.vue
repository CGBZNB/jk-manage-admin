<template>
  <div class="app-container">
    ...
    <el-table-column label="使用年限" width="150px">
        <template slot-scope="{row}">
           <span>{{ row.age }}</span>
        </template>
      </el-table-column>
       <el-table-column label="驾校" width="150px">
        <template slot-scope="{row}">
           <span>{{ row.school.name }}</span>
        </template>
      </el-table-column>
       <el-table-column label="教练" width="150px">
        <template slot-scope="{row}">
           <span>{{ row.school.name}}</span>
        </template>
      </el-table-column>
 ...
 <el-form-item label="品牌" prop="title">
      ...
      <el-form-item label="使用年限" prop="title">
  ...
  methods: {
   async getList() {
      ...
      try{
         ...
         this.list=this.$store.state.car.cars
