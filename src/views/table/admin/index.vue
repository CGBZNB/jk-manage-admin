  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="电话" min-width="150px">
       ...
       <el-table-column label="角色" min-width="150px" prop="role">
        <template slot-scope="{row}">
           <span>{{ row.userLogin.role==null?'':row.userLogin.role.name }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
          ...
          <el-input :value="temp.userLogin.role==null?'':temp.userLogin.role.name" disabled/>
        </el-form-item>
  ...
  methods: {
   async getList() {
      ...
      try{
         ...
         this.list=this.$store.state.admin.admins
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        ...
        const filterVal = ['name', 'phone', 'userLogin.role', 'userLogin.roleacoount', 'status']
